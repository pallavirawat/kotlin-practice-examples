...
//    numbers = numbers.others.dropCustom(1,1).filter {
//            println("inside filter for number $it")
//            true
//    }
//    numbers = numbers.others.dropCustom(1,2).filter {
